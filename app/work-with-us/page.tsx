...
export const metadata: Metadata = {
  title: "Work With Us",
  description:
    "Every Tekmera engagement runs as a four-month sprint. We translate your strategy into a buildable system and decide what gets built, in what order.",
  openGraph: {
    title: "Work With Us | Tekmera",
    description:
      "Every Tekmera engagement runs as a four-month sprint. We translate your strategy into a buildable system and decide what gets built, in what order.",
  },
};
