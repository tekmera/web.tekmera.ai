...
export const metadata: Metadata = {
  title: "Adobe Workfront & Fusion Architecture",
  description:
    "Enterprise Workfront and Fusion architecture, custom API implementations, AI-augmented automation, and proprietary diagnostic tooling. Operating at scale since 2017.",
  openGraph: {
    title: "Adobe Workfront & Fusion Architecture | Tekmera",
    description:
      "Enterprise Workfront and Fusion architecture, custom API implementations, AI-augmented automation, and proprietary diagnostic tooling. Operating at scale since 2017.",
  },
};
...
export default function AdobePracticePage() {
  return (
        ...
        <div className="space-y-10">
          <div>
            ...
            <div className="space-y-4">
              <Image src="/explorer-summary-0.png" alt="Blueprint Summary Report — Overview" width={800} height={450} className="w-full rounded-md border border-border" />
              <Image src="/explorer-summary-1.png" alt="Blueprint Summary Report — Component Analysis" width={800} height={450} className="w-full rounded-md border border-border" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <Image src="/explorer-search-1.png" alt="Cross-Blueprint Search — Overview" width={800} height={450} className="w-full rounded-md border border-border" />
              <Image src="/explorer-search-2.png" alt="Cross-Blueprint Search — Match Detail" width={800} height={450} className="w-full rounded-md border border-border" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <Image src="/explorer-diff-1.png" alt="Blueprint Diff — Summary" width={800} height={450} className="w-full rounded-md border border-border" />
              <Image src="/explorer-diff-2.png" alt="Blueprint Diff — Change Details" width={800} height={450} className="w-full rounded-md border border-border" />
            </div>
          </div>
        </div>
