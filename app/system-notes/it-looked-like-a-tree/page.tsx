...
export const metadata: Metadata = {
  title: "It Looked Like a Tree",
  description:
    "Porting a Fusion scenario to Make.com wasn't just cleanup. It was an architectural reveal. From 250 modules to 35.",
  openGraph: {
    title: "It Looked Like a Tree | Tekmera",
    description:
      "Porting a Fusion scenario to Make.com wasn't just cleanup. It was an architectural reveal. From 250 modules to 35.",
  },
};

export default function ItLookedLikeATreePage() {
  return (
    <article className="max-w-3xl mx-auto px-6 pt-20 pb-16 md:pt-28 md:pb-24">
      ...
      <div className="text-secondary-foreground leading-relaxed space-y-4">
        ...
        <p>The client said: &ldquo;I&apos;m not an expert in this stuff.&rdquo;</p>
