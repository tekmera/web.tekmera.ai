    ...
    <article className="max-w-3xl mx-auto px-6 pt-20 pb-16 md:pt-28 md:pb-24">
      ...
      <div className="text-secondary-foreground leading-relaxed space-y-4">
        ...
        <ul className="space-y-3 pl-5 list-disc marker:text-primary">
          <li><span className="text-foreground font-medium">No mechanism to enforce execution intent.</span> A process labeled "one-time" can run forever and nothing stops it.</li>
...
export default RunawayOneTimeScenario;
