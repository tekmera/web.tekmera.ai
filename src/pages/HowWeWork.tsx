    ...
    <article className="max-w-3xl mx-auto px-6 pt-20 pb-16 md:pt-28 md:pb-24">
      ...
      <section className="mb-16 border-t border-border pt-12">
        ...
        <div className="text-secondary-foreground leading-relaxed space-y-4">
          <p>
            We map what your system is actually doing — not what you think it's doing. A fixed-scope diagnostic that surfaces hidden logic, structural risks, dependencies, and the assumptions holding everything together.
          </p>
          <p>
            This isn't a checkbox audit. It's a structural picture of your environment that tells you what's working, what's fragile, and what will break next.
          </p>
          ...
          <ul className="space-y-2 pl-5 list-disc marker:text-primary">
            ...
            <li>An honest assessment of what can be fixed vs. what needs rebuilding</li>
      ...
      <section className="mb-16 border-t border-border pt-12">
        ...
        <h2 className="text-2xl text-foreground mb-6">Design & Build — with intent, not just speed.</h2>
        <div className="text-secondary-foreground leading-relaxed space-y-4">
          <p>
            When the current system won't hold or you're building something new, we design and build with intent. System redesign, automation, data pipelines, AI implementation — built for production, not demos.
          </p>
          <h3 className="text-foreground font-body font-semibold text-base mt-8 mb-3">What you get:</h3>
          <ul className="space-y-2 pl-5 list-disc marker:text-primary">
            ...
            <li>Stakeholder walkthroughs — your team understands what was built and why</li>
          </ul>
          <p className="mt-6">
      ...
      <section className="mb-16 border-t border-border pt-12">
        ...
        <div className="text-secondary-foreground leading-relaxed space-y-4">
          ...
          <ul className="space-y-2 pl-5 list-disc marker:text-primary">
            ...
            <li>Oversight of all delivery — internal or external</li>
      ...
      <section className="border-t border-border pt-12">
        <div className="text-secondary-foreground leading-relaxed space-y-4 mb-8">
          <p>
            These three phases aren't separate products. They're how every engagement runs — whether it takes two weeks or two years. The discipline is the same: understand first, design with intent, and make sure it holds.
          </p>
